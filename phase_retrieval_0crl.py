...
#fnames = ['scan-0657.h5','scan-0658.h5','scan-0659.h5','scan-0660.h5','scan-0661.h5','scan-0662.h5','scan-0663.h5','scan-0664.h5','scan-0665.h5','scan-0666.h5'] # 0 CRL
fnames = ['scan-0657.h5','scan-0660.h5','scan-0661.h5','scan-0662.h5','scan-0663.h5'] # 0 CRL


df = 'scan-0594.h5' # dark field 0 CRL
ff = 'scan-0656.h5' # flat field 0 CRL
...
rad = rads[0]
dist = distances_rec[0]

Sd_Paganin = Paganin(rad, wlen, dist, delta, beta, fx, fy, Rm)  

fig, ax = plt.subplots(1,1)
im=ax.imshow(Sd_Paganin,extent=[x_mu.min(), x_mu.max(), x_mu.min(), x_mu.max()])
#ax.set_ylabel(r"Distance ($\mathrm{\mu}$m)", fontsize = fs)
#ax.set_xlabel(r"Distance ($\mathrm{\mu}$m)", fontsize = fs)
# Add the colorbar
cbar = fig.colorbar(im, ax=ax)
...
ax2.text(271, 5.45-4.928, "Ring", color='black', ha='center', va='center', fontsize=15)
...
ax3.plot(arr_len,line_values_spot1[7:120],'.-',linewidth=2,label='Data', color='red')
ax3.set_ylabel(r"$\tilde{\phi}(f)$", fontsize = fs)
ax3.set_xlabel("Spatial position ($\\mathrm{\\mu}$m)", fontsize = fs)
ax3.text(1, 4.77-4.928, "Line 1", color='black', ha='center', va='center', fontsize=15)
ax3.set_ylim(4.38-4.928, 5.7-4.928)
...
ax4.plot(arr_len,line_values_spot2[:120-7],'.-',linewidth=2,label='Data', color='red')
...
ax4.text(1, 4.8-4.928, "Line 2", color='black', ha='center', va='center', fontsize=15)
ax4.set_ylim(4.38-4.928, 5.7-4.928)
...
#axs[1].plot(line_values_spot1_pf,linewidth=2,label='Line Values', color='red')
#axs[1].plot(fitted_sine_wave,linewidth=2,label='Line Values', color='black')
axs[1].plot(arr_len,corrected_data+np.mean(fitted_sine_wave),'*-', label='Corrected Data', color='red')
...
#axs[0].set_ylabel(r"Distance ($\mathrm{\mu}$m)", fontsize = fs)
#axs[0].set_xlabel(r"Distance ($\mathrm{\mu}$m)", fontsize = fs)
#axs[1].plot(line_values_spot2_pf,linewidth=2,label='Line Values', color='red')
#axs[1].plot(fitted_sine_wave,linewidth=2,label='Line Values', color='black')
axs[1].plot(arr_len,corrected_data+np.mean(fitted_sine_wave),'*-', label='Corrected Data', color='red')
axs[1].set_ylabel("Corrected intensity", fontsize = fs)
#axs[1].set_xlabel("Line distance (pixels)", fontsize = fs)
