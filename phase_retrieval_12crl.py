...
#fnames = ['scan-0623.h5','scan-0624.h5','scan-0625.h5','scan-0626.h5','scan-0628.h5','scan-0629.h5','scan-0630.h5','scan-0631.h5','scan-0632.h5','scan-0633.h5'] # 12 crl
fnames = ['scan-0623.h5','scan-0626.h5','scan-0628.h5','scan-0629.h5','scan-0630.h5'] # 12 crl
df = 'scan-0594.h5' # dark field  12 crl
ff = 'scan-0622.h5' # flat field 12 crl
...
shifts = np.array([[23.79999924,  -8.60000038]])
...
ax2.set_xlabel("Spatial position (°)", fontsize = fs)
...
ax3.text(1, 4.75, "Line 1", color='black', ha='center', va='center', fontsize=15)
ax3.set_ylim(4.38, 5.7)
...
ax4.text(1, 4.8, "Line 2", color='black', ha='center', va='center', fontsize=15)
ax4.set_ylim(4.38, 5.7)
